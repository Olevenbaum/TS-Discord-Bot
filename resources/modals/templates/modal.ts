...
// Type imports
import { ActionRowBuilder, ModalActionRowComponentBuilder, ModalBuilder, ModalSubmitInteraction } from "discord.js";
...
const modal: SavedModal = {
    ...
    create(configuration: Configuration, options = {}): ModalBuilder {
        ...
        for (const includedComponent of this.includedComponents) {
             ...
             */
            const modalComponent = components[includedComponent.type].get(includedComponent.name) as
                | SavedModalComponent
                | undefined;
